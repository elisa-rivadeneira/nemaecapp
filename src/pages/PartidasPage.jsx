...
import { Search, ArrowLeft, Filter, CheckCircle2, Clock, AlertTriangle, XCircle } from 'lucide-react'
...
export default function PartidasPage() {
  ...
  const { comisariaSeleccionada, getPartidasComisaria, getAcumuladoPartida } = useAppStore()
              ...
              {isOpen && (
                <div className="border-t border-gray-100 px-4 py-3 bg-gray-50">
                  ...
                  <button
                    ...
                    disabled={avance >= 100}
                    className="w-full bg-brand-700 text-white py-2.5 rounded-xl text-sm font-semibold active:bg-brand-800 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                  >
